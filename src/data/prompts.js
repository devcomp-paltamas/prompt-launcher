...
export const PROMPTS = [
  ...
  // --- ÚJ PROMPTOK ---
  {
    id: 'review-dependencies', cat: 'review', icon: '🔗',
    title: 'Függőség térkép', sub: 'Ki mit hív, ki mitől függ',
    desc: 'Osztály függőségeinek vizualizálása: interfészek, injektált osztályok, hívási lánc.',
    tools: ['adt'], vars: ['OSZTÁLYNÉV'],
    prompt: `Kérd le a(z) [OSZTÁLYNÉV] forráskódját (abap-adt).
...
[OSZTÁLYNÉV]
  ...
  {
    id: 'code-interface', cat: 'code', icon: '📐',
    title: 'Interfész + implementáció', sub: 'Clean architecture minta',
    desc: 'Interfész definíció és alapértelmezett implementáció generálása.',
    tools: ['adt'], vars: ['INTERFÉSZ_NÉV', 'METÓDUSOK_LEÍRÁSA'],
...
Írd vissza és aktiváld mindkettőt (abap-adt).`,
  },
  {
    id: 'code-badi', cat: 'code', icon: '🔌',
    title: 'BAdI implementáció', sub: 'Enhancement spot kitöltése',
    desc: 'BAdI definícióból implementáció generálása a megfelelő filterekkel.',
    tools: ['adt', 'docs'], vars: ['BADI_NÉV', 'FILTER_ÉRTÉKEK', 'LOGIKA'],
    prompt: `Keresd meg a [BADI_NÉV] BAdI definíciót (abap-adt).
...
Hozd létre az enhancement implementation-t és aktiváld.`,
  ...
  {
    id: 'code-alv-report', cat: 'code', icon: '📊',
    title: 'ALV Report generálás', sub: 'SALV vagy CL_GUI_ALV_GRID',
    desc: 'Teljes ALV report szelekciós képernyővel, SALV osztállyal.',
    tools: ['adt'], vars: ['REPORT_NÉV', 'TÁBLA_VAGY_CDS', 'SZELEKCIÓS_MEZŐK'],
...
Írd vissza és aktiváld!`,
  ...
  {
    id: 'test-sql-double', cat: 'test', icon: '🗃️',
    title: 'SQL Test Double', sub: 'CDS/OSQL mock adatokkal',
    desc: 'Adatbázis függőség izolálása test double-lal unit teszthez.',
    tools: ['adt'], vars: ['OSZTÁLYNÉV', 'TÁBLA_NEVEK'],
    prompt: `Kérd le a(z) [OSZTÁLYNÉV] forráskódját (abap-adt).
...
Integráld a meglévő LTCL_* teszt osztályba.`,
  ...
  {
    id: 'debug-data-flow', cat: 'debug', icon: '🔀',
    title: 'Adatfolyam nyomkövetés', sub: 'Változó értékek követése',
    desc: 'Adott változó értékének követése a kódon keresztül, hol módosul.',
    tools: ['adt'], vars: ['OSZTÁLYNÉV', 'VÁLTOZÓ_NÉV'],
    prompt: `Kérd le a(z) [OSZTÁLYNÉV] forráskódját (abap-adt).
...
Készíts folyamatábrát a változó életciklusáról.`,
  ...
  {
    id: 'debug-idoc', cat: 'debug', icon: '📨',
    title: 'IDoc hibakeresés', sub: 'WE02/WE05 státusz elemzés',
    desc: 'IDoc feldolgozási hiba elemzése és javítási javaslat.',
    tools: ['adt', 'docs'], vars: ['IDOC_TÍPUS', 'HIBAÜZENET'],
...
4. Milyen WE19 teszt adatokkal reprodukálható?`,
  ...
  {
    id: 'workflow-refactor', cat: 'workflow', icon: '♻️',
    title: 'Refaktorálási terv', sub: 'Legacy kód modernizálás',
...
Ne implementálj, csak tervezz!`,
  ...
  {
    id: 'workflow-migration', cat: 'workflow', icon: '☁️',
    title: 'ABAP Cloud migráció', sub: 'On-premise → BTP előkészítés',
...
- Released API javaslat (docs szerver)`,
  ...
  // --- TOVÁBBI MINTÁK ---
  {
    id: 'review-naming', cat: 'review', icon: '🏷️',
    title: 'Névkonvenció ellenőrzés', sub: 'SAP/Clean ABAP szabályok',
...
Listázd a nem megfelelő elnevezéseket és adj javaslatot!`,
  ...
  {
    id: 'review-clean-code', cat: 'review', icon: '✨',
    title: 'Clean ABAP audit', sub: 'Olvashatóság és karbantarthatóság',
...
Adj prioritizált javítási listát!`,
  ...
  {
    id: 'code-cds-view', cat: 'code', icon: '📊',
    title: 'CDS View generálás', sub: 'Annotation-ökkel',
    desc: 'CDS view létrehozása a megadott táblákból, megfelelő annotációkkal.',
    tools: ['adt', 'docs'], vars: ['VIEW_NÉV', 'ALAP_TÁBLA', 'MEZŐK', 'SZŰRÉS'],
...
Írd vissza és aktiváld (abap-adt)!`,
  },
  {
    id: 'code-rap-bo', cat: 'code', icon: '🏛️',
    title: 'RAP Business Object', sub: 'Managed / Unmanaged BO',
    desc: 'Teljes RAP Business Object generálása: CDS, behavior, projection.',
    tools: ['adt', 'docs'], vars: ['ENTITÁS_NÉV', 'ALAP_TÁBLA', 'MŰVELETEK'],
...
Aktiváld az összes objektumot!`,
  ...
  {
    id: 'code-exception', cat: 'code', icon: '⚠️',
    title: 'Kivétel osztály generálás', sub: 'CX_ osztály hierarchia',
    desc: 'ABAP kivétel osztály létrehozása üzenet osztállyal és szövegekkel.',
    tools: ['adt'], vars: ['KIVÉTEL_NÉV', 'ÜZENET_TÍPUSOK'],
...
Írd vissza és aktiváld!`,
  ...
  {
    id: 'code-factory', cat: 'code', icon: '🏭',
    title: 'Factory pattern implementáció', sub: 'Dependency Injection előkészítés',
...
Aktiváld az összes új objektumot!`,
  ...
  {
    id: 'test-integration', cat: 'test', icon: '🔗',
    title: 'Integrációs teszt', sub: 'Több osztály együttműködése',
    desc: 'Integrációs teszt több osztály együttműködésének tesztelésére.',
    tools: ['adt'], vars: ['OSZTÁLY_1', 'OSZTÁLY_2', 'SZCENÁRIÓ'],
    prompt: `Kérd le a következő osztályokat (abap-adt):
- [OSZTÁLY_1]
- [OSZTÁLY_2]
...
Ne mock-olj mindent - a cél az integráció tesztelése!`,
  ...
  {
    id: 'test-exception', cat: 'test', icon: '💣',
    title: 'Kivétel tesztek', sub: 'Negatív test case-ek',
...
Integráld a meglévő teszt osztályba.`,
  ...
  {
    id: 'debug-memory', cat: 'debug', icon: '🧠',
    title: 'Memória analízis', sub: 'Internal table méret, referenciák',
...
Adj memory profiling tippeket (ST05, SAT)!`,
  ...
  {
    id: 'debug-lock', cat: 'debug', icon: '🔒',
    title: 'Lock konfliktus elemzés', sub: 'Enqueue / Dequeue problémák',
    desc: 'Zárolási problémák azonosítása és megoldási javaslatok.',
    tools: ['adt', 'docs'], vars: ['OSZTÁLYNÉV', 'LOCK_OBJEKTUM'],
    prompt: `Kérd le a(z) [OSZTÁLYNÉV] forráskódját (abap-adt).
...
- SM12 / SM21 debugging lépéseket`,
  ...
  {
    id: 'debug-auth', cat: 'debug', icon: '👮',
    title: 'Jogosultság hibakeresés', sub: 'AUTHORITY-CHECK problémák',
    desc: 'Jogosultsági problémák diagnosztizálása: SU53, auth trace.',
    tools: ['adt', 'docs'], vars: ['OSZTÁLYNÉV', 'AUTH_OBJEKTUM'],
    prompt: `Kérd le a(z) [OSZTÁLYNÉV] forráskódját (abap-adt).
...
Ha hiányzik ellenőrzés, adj kódrészletet.`,
  ...
  {
    id: 'workflow-code-review-pr', cat: 'workflow', icon: '👀',
    title: 'Pull Request Review', sub: 'Változások elemzése',
    desc: 'Két verzió összehasonlítása és review jegyzőkönyv készítése.',
    tools: ['adt'], vars: ['OSZTÁLYNÉV', 'VÁLTOZTATÁS_LEÍRÁS'],
    prompt: `Kérd le a(z) [OSZTÁLYNÉV] forráskódját (abap-adt).
...
Kommentek soronként ahol szükséges.`,
  ...
  {
    id: 'workflow-transport', cat: 'transport', icon: '📦',
    title: 'Transzport előkészítés', sub: 'Objektum lista és függőségek',
    desc: 'Transzporthoz szükséges objektumok és függőségeik azonosítása.',
    tools: ['adt'], vars: ['OSZTÁLYNÉV', 'CÉLRENDSZER'],
    prompt: `Kérd le a(z) [OSZTÁLYNÉV] és függőségeinek forráskódját (abap-adt).
...
Figyelmeztetések ha van rendszer-függő hardkódolt érték!`,
  ...
  {
    id: 'workflow-compare', cat: 'workflow', icon: '⚖️',
    title: 'Kód összehasonlítás', sub: 'Két osztály diff elemzése',
    desc: 'Két osztály vagy verzió közötti különbségek azonosítása és dokumentálása.',
    tools: ['adt'], vars: ['OSZTÁLY_1', 'OSZTÁLY_2'],
    prompt: `Kérd le mindkét osztályt (abap-adt):
- [OSZTÁLY_1]
- [OSZTÁLY_2]
...
Táblázatos formátum + ajánlás melyik a jobb megoldás.`,
  ...
  {
    id: 'code-select', cat: 'code', icon: '🔍',
    title: 'Optimális SELECT írás', sub: 'Teljesítmény-optimalizált lekérdezés',
    desc: 'SELECT statement optimalizálása: index használat, JOIN vs FOR ALL ENTRIES.',
    tools: ['adt', 'docs'], vars: ['TÁBLÁK', 'FELTÉTELEK', 'MEZŐK'],
...
Említsd meg az ST05 trace lépéseket az ellenőrzéshez.`,
  ...
  {
    id: 'code-json', cat: 'code', icon: '📋',
    title: 'JSON / XML feldolgozás', sub: 'Szerializáció és deszerializáció',
    desc: 'JSON vagy XML adatstruktúra ABAP típusra konvertálása és vissza.',
    tools: ['adt', 'docs'], vars: ['FORMÁTUM', 'STRUKTÚRA_LEÍRÁS'],
...
Error handling: mit csinálj hibás input esetén?`,
  ...
  {
    id: 'code-http-client', cat: 'code', icon: '🌐',
    title: 'HTTP kliens implementáció', sub: 'REST API hívás',
    desc: 'HTTP kliens osztály létrehozása REST API hívásokhoz, error handling-gel.',
    tools: ['adt', 'docs'], vars: ['API_URL', 'AUTH_TÍPUS', 'MŰVELETEK'],
...
Adj ICF service debugging tippeket is!`,
  ...
  {
    id: 'debug-trace', cat: 'debug', icon: '📍',
    title: 'Futási nyomkövetés', sub: 'Logging és trace implementálás',
    desc: 'Átmeneti trace logika hozzáadása hibakereséshez, majd eltávolítás.',
    tools: ['adt'], vars: ['OSZTÁLYNÉV', 'METÓDUS_LISTA'],
    prompt: `Kérd le a(z) [OSZTÁLYNÉV] forráskódját (abap-adt).
...
FONTOS: Kommenteld meg a trace sorokat "TODO: Remove trace" megjegyzéssel!`,
  ...
  {
    id: 'test-scenario', cat: 'test', icon: '🎬',
    title: 'Szcenárió alapú teszt', sub: 'End-to-end user story teszt',
    desc: 'Teljes user story lefedése tesztekkel, given-when-then formátumban.',
    tools: ['adt'], vars: ['USER_STORY', 'ÉRINTETT_OSZTÁLYOK'],
    prompt: `User story: [USER_STORY]
Érintett osztályok: [ÉRINTETT_OSZTÁLYOK]

Kérd le az osztályokat (abap-adt) és generálj szcenárió teszteket.
...
Minden szcenárióhoz külön teszt metódus!`,
  ...
  {
    id: 'transport-conflict', cat: 'transport', icon: '⚔️',
    title: 'Transzport ütközés elemzés', sub: 'Konfliktusok azonosítása',
    desc: 'Két vagy több transzport közötti ütközések és átfedések felderítése.',
    tools: ['adt'], vars: ['TRANSZPORT_1', 'TRANSZPORT_2'],
...
SE09/SE10 és STMS lépések az ellenőrzéshez!`,
  ...
  {
    id: 'transport-dependency', cat: 'transport', icon: '🔗',
    title: 'Függőség analízis', sub: 'Előfeltétel transzportok',
    desc: 'Transzport függőségeinek feltérképezése - mi kell előtte.',
    tools: ['adt'], vars: ['TRANSZPORT_SZÁM'],
...
Adj STMS import queue sorrendet.`,
  ...
  {
    id: 'transport-object-lock', cat: 'transport', icon: '🔐',
    title: 'Objektum zárolás keresés', sub: 'Ki módosítja / zárolj',
    desc: 'Azonos objektumon dolgozó fejlesztők és transzportok azonosítása.',
    tools: ['adt'], vars: ['OBJEKTUM_NÉV'],
...
Javaslat ha ütközés van!`,
  ...
  {
    id: 'transport-cross-system', cat: 'transport', icon: '🔄',
    title: 'Rendszerek közötti összehasonlítás', sub: 'DEV vs QAS vs PRD diff',
    desc: 'Objektum verzióinak összehasonlítása különböző rendszerekben.',
    tools: ['adt'], vars: ['OBJEKTUM_NÉV', 'RENDSZER_1', 'RENDSZER_2'],
...
SE39 / SE95 program összehasonlítás lépések!`,
  ...
  {
    id: 'transport-release-check', cat: 'transport', icon: '✅',
    title: 'Release előtti ellenőrzés', sub: 'Go/No-Go checklist',
...
Release STMS lépések és SE09 útmutató!`,
  ...
  {
    id: 'transport-hotfix', cat: 'transport', icon: '🚨',
    title: 'Sürgős hotfix transzport', sub: 'Emergency change folyamat',
    desc: 'Sürgős javítás transzportálása a megfelelő eljárással.',
    tools: ['adt'], vars: ['HIBA_LEÍRÁS', 'ÉRINTETT_OBJEKTUMOK'],
...
- Retrofit KÖTELEZŐ a konzisztenciához!`,
  ...
  {
    id: 'transport-retrofit', cat: 'transport', icon: '⬅️',
    title: 'Retrofit tervezés', sub: 'PRD → DEV visszaszállítás',
    desc: 'Termelési változások visszaszállítása fejlesztői rendszerbe.',
    tools: ['adt'], vars: ['PROD_TRANSZPORT', 'DEV_VÁLTOZÁSOK'],
...
KRITIKUS: Dokumentáld mi lett merge-ölve!`,
  ...
  {
    id: 'transport-queue', cat: 'transport', icon: '📋',
    title: 'Import queue rendezés', sub: 'STMS sorrend optimalizálás',
    desc: 'Import queue sorrendjének ellenőrzése és optimalizálása.',
    tools: ['adt'], vars: ['CÉLRENDSZER', 'TRANSZPORT_LISTA'],
...
Import opciók javaslat (Overwrite, Ignore)!`,
  ...
  {
    id: 'transport-compare-versions', cat: 'transport', icon: '📊',
    title: 'Verzió történet elemzés', sub: 'Objektum változási napló',
    desc: 'Objektum teljes verzió történetének és változásainak elemzése.',
    tools: ['adt'], vars: ['OBJEKTUM_NÉV'],
    prompt: `Elemezd a(z) [OBJEKTUM_NÉV] verzió történetét (abap-adt).
...
SE39 verzió összehasonlítás lépések!`,
  ...
  {
    id: 'transport-missing-objects', cat: 'transport', icon: '❓',
    title: 'Hiányzó objektumok keresése', sub: 'Aktiválási hibák diagnosztika',
    desc: 'Import utáni aktiválási hibák és hiányzó függőségek felderítése.',
    tools: ['adt', 'docs'], vars: ['HIBAÜZENET', 'TRANSZPORT_SZÁM'],
...
SE11 / SE80 hibakeresési lépések!`,
  ...
  {
    id: 'transport-rollback', cat: 'transport', icon: '⏪',
    title: 'Rollback terv készítés', sub: 'Visszaállítási stratégia',
    desc: 'Transzport visszagörgetési terv készítése problémás import esetére.',
    tools: ['adt'], vars: ['TRANSZPORT_SZÁM', 'ÉRINTETT_OBJEKTUMOK'],
